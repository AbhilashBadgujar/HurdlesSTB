...
function sizeHandler() {
	...
	var destH = Math.round(CANVAS_HEIGHT * multiplier);
        ...
        if(s_oChooseMenu !== null){
            s_oChooseMenu.refreshButtonPos( );
        };
...
this.tweenVectors = function( vStart, vEnd, iLerp ){
    vOut = {x:vStart.x + iLerp *( vEnd.x-vStart.x),y:vStart.y + iLerp *( vEnd.y - vStart.y)};
    return vOut;
};
...
function fullscreenHandler(){
    ...
    if(s_oChooseMenu !== null){
        s_oChooseMenu.resetFullscreenBut( );
    };
}
